...
import com.raket.silverstripe.psi.references.SilverStripeFieldReference;
...
public class SilverStripeVariablePsiReferenceProvider extends PsiReferenceProvider {
	...
	public PsiReference[] getReferencesByElement(@NotNull PsiElement element, @NotNull ProcessingContext context) {
		...
		else if (element instanceof SilverStripeFieldReferenceImpl) {
			SilverStripeFieldReferenceImpl se = (SilverStripeFieldReferenceImpl) element;
			return new PsiReference[]{new SilverStripeFieldReference(se)};
		}
