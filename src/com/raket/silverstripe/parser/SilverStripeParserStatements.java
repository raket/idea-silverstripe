...
public class SilverStripeParserStatements {
	...
	static TokenSet endStatementTokens = TokenSet.create(SS_BLOCK_START, SS_END_KEYWORD, SS_BLOCK_END);
	...
	static {
		...
		STATEMENT_MAP.put(SS_END_KEYWORD,endStatementTokens);
		//STATEMENT_MAP.put(SS_COMMENT_START,commentTokens);
		...
		BLOCK_TYPE_MAP.put(SS_END_KEYWORD, SS_BLOCK_END_STATEMENT);
	}
}
